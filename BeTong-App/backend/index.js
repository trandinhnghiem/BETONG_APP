...
io.on('connection', (socket) => {
  ...
  socket.on('join_station', (stationId) => {
    ...
    console.log(
      `✅ Joined room station_${stationId}`
    )
...
const statisticsRoutes =
  require('./routes/statisticsRoutes')
  ...
  try {
    ...
    for (const data of stationDefinitions) {
      ...
      if (!station) {
        ...
        station =
          await StationModel.create(data)
